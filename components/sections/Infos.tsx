                    ...
                    {chiffres.map((chiffre, index) => (
                        index <= 2 ? (
                            <div key={index} className="md:w-[340px] max-[415px]:w-[15rem] w-[20rem] flex flex-col items-start justify-start gap-2">
                                ...
                                <div className="px-7 font-sans overflow-hidden">
                                    <p className="description-chiffre max-[415px]:text-xl text-2xl font-light text-gray-600 leading-6 relative before:content-[''] before:absolute before:-left-6 before:top-2 before:w-3 before:h-3 before:rounded-full before:bg-blue-500 before:drop-shadow-[0_0_3px_rgba(0,150,255,.6)] before:z-10">
                                        {chiffre.description}
                                    </p>
                                </div>
                            </div>
                    ...
                    {chiffres.map((chiffre, index) => (
                        index > 2 ? (
                            <div key={index} className="md:w-[450px] max-[415px]:w-[15rem] w-[20rem] md:px-5 px-0 flex flex-col items-start justify-start gap-2">
                                ...
                                <div className="max-[415px]: px-7 font-sans overflow-hidden">
                                    <p className="description-chiffre max-[415px]:text-xl text-2xl font-light text-gray-600 leading-6 relative before:content-[''] before:absolute before:-left-6 before:top-2 before:w-3 before:h-3 before:rounded-full before:bg-blue-500 before:drop-shadow-[0_0_3px_rgba(0,150,255,.6)] before:z-10">
                                        {chiffre.description}
                                    </p>
                                </div>

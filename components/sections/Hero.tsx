...
function Hero() {
  ...
  return (
    ...
    <main ref={heroRef} className="hero z-99 relative w-full h-screen px-10 pt-50 pb-5 flex flex-col items-center justify-between bg-background text-foreground ">
